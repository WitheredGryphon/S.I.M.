...
if(isset($_POST['addStudent']))
{
    ...
    $generateInfoTable = "CREATE TABLE IF NOT EXISTS Students(
    ...
    if(!mysqli_query($link, $generateInfoTable))
    {
        ...
        $insertStudent = "INSERT INTO Students(FirstName, LastName, Email, Address)
...
<html>
    ...
    <body>
        ...
        <br />
        <div class = "container">
            <h1><p align = center>New Student Form</p></h1>
            <form id = "student" method = "POST" action="<?php echo $_SERVER['PHP_SELF'] ?>">
                <p align = center><b>First Name: </b><input type = "text" name = "fname"></p>
                <p align = center><b>Last Name: </b><input type = "text" name = "lname"></p>
                <p align = center><b>New Student Email: </b><input type = "text" name = "email" value = ""></p>
                <p align = center><b>Address: </b><input type = "text" name = "address"></p>
                <br />
                 <p align = center><input type = "submit" value = "Submit" name = "addStudent"></p>
            </form>
        </div>
    </body>
</html>