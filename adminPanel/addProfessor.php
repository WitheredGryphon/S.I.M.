...
if(isset($_POST['addProf']))
{
    ...
    $generateInfoTable = "CREATE TABLE IF NOT EXISTS Instructors(
    ...
    if(!mysqli_query($link, $generateInfoTable))
    {
        ...
        $insertStudent = "INSERT INTO Instructors(FirstName, LastName, Email, Address)
...
<html>
    ...
    <body>
        ...
        <br />
        <div class = "container">
            <h1><p align = center>New Professor Form</p></h1>
            <form id = "admin" method = "POST" action="<?php echo $_SERVER['PHP_SELF'] ?>">
                ...
                <p align = center><b>New Professor Email: </b><input type = "text" name = "email"></p>
                <p align = center><b>Address: </b><input type = "text" name = "address"></p>
                <br />
                 <p align = center><input type = "submit" value = "Submit" name = "addProf"></p>
            </form>
        </div>
    </body>
</html>